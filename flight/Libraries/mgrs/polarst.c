...
static double Polar_Origin_int = 0.0;                /* longitude of origin in radians */
...
//  const double  epsilon = 1.0e-2;
  ...
  { /* no errors */
    ...
    if (Latitude_of_True_Scale < 0)
    {
      ...
      Polar_Origin_int = -longitude_Down_from_Pole;
    }
    else
    {
 ...
 */
  ...
  *longitude_Down_from_Pole = Polar_Origin_int;
 ...
 */
  ...
  {  /* no errors */
    ...
    else
    {
      ...
      dlam = longitude - Polar_Origin_int;
      if (dlam > PI)
      {
        dlam -= TWO_PI;
      }
  ...
  if (!Error_Code)
  {
    ...
    { /* no errors */
      ...
      else
      {
        ...
        *Latitude = PHI;
        *longitude = Polar_Origin_int + atan2(dx, -dy);
