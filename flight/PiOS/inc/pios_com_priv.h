...
extern int32_t PIOS_COM_Init(struct pios_com_dev **com_id, const struct pios_com_driver *driver, void *lower_id, uint16_t rx_buffer_len, uint16_t tx_buffer_len);
