...
void HITLWidget::startButtonClicked()
{
	...
	{
        qDebug() << "There is no registered simulators, add through HITLPlugin::addSimulator";
		return;
	}
    ...
    qDebug() << "HITL: Starting " + creator->Description();
	...
	if(ret)
	{
        ...
        qDebug() << "HITL: Starting bridge, initializing flight simulator and Autopilot connections";
